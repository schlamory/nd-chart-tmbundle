...
describe Nd::Patient do
  ...
  context "after .create_dir_if_absent" do
    ...
    context "after .initialize_files_if_absent" do
      ...
      it ".patient_dir_containing_path patient.visits_dir_path is patient.dir_path" do
        expect(Nd::Patient.patient_dir_containing_path patient.visits_dir_path).to eq patient.dir_path
      end
